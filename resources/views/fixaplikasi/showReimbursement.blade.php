...
@section('content')
    ...
    <hr>
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="aplikasiID">{{$jenis->name}}</label>
                    </div> 
                </div>
            </div>
        </div>
        ...
        @if ($orderfixaplikasi->status != 'PENDING')
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <textarea class="form-control" name="statusDetail" id="" cols="30" rows="5" readonly>{{$orderfixaplikasi->statusDetail}}</textarea>
                </div>
            </div>
        ...
        <a href="/myfixaplikasi" class="btn btn-dark">Back</a>   
