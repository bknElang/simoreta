...
@section('content')
    ...
    <form action="/searchmyfixcomputer" method="get">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <a href="/myfixcomputer"" class="btn btn-dark">Clear Filter</a>
            </div>
        </div>
    </form>
        ...
        <div class="col-sm-12">
            <table class="table table-hover table-responsive-sm">
                <thead>
                    ...
                    <th class="col-sm-2" style="width: 100px"><b>Komponen Komputer</b></th>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle">
                            @if ($orderfixcomputer->status == "Waiting for Approval")
                                <label style="color:#606060"><b>{{ $orderfixcomputer->status}}</b></label>
                            @elseif ($orderfixcomputer->status == "REJECTED")
                                <label style="color:#CC0000"><b>{{ $orderfixcomputer->status}}</b></label>
                            @elseif ($orderfixcomputer->status == "PENDING")
                                <label style="color:#CC6600"><b>{{ $orderfixcomputer->status}}</b></label>
