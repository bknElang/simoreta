        ...
        <div class="col-sm-12">
            <table class="table table-hover table-responsive-sm">
                <thead>
                    ...
                    <td class="col-sm-2" style="width: 100px"><b>Nama Tujuan</b></td>
                    <td class="col-sm-2" style="width: 100px"><b>PIC Penerima</b></td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif ($kiriman->status == "IN PROGRESS")
                                <label style="color:#CCCC00"><b>{{ $kiriman->status}}</b></label>
                            @else
                                <label style="color:lime"><b>{{ $kiriman->status}}</b></label>
                            @endif
                        </td>
                    </tr>
                @endforeach   
