            ...
            <div class="col-sm-4">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="komponenkomputerID">{{$jenis->name}}</label>
                    </div> 
                </div>
            </div>
        </div>
        ...
        @if ($orderfixhardware->status != 'PENDING')
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <textarea class="form-control" name="statusDetail" id="" cols="30" rows="5" readonly>{{$orderfixhardware->statusDetail}}</textarea>
                </div>
            </div>
