...
@section('content')
    ...
    <form action="/searchauthfixhardware" method="get">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <a href="/authfixhardware" class="btn btn-dark">Clear Filter</a>
            </div>
        </div>
    </form>
        ...
        <div class="col-sm-12">
            <table class="table table-hover table-responsive-sm">
                <thead>
                    ...
                    <td class="col-sm-2" style="width: 100px"><b>Jenis Hardware</b></td>
                </thead>

                @foreach ($orderfixhardware as $orderfixhardware)
                    <tr>
                        <td style="vertical-align: middle"><a href="/authfixhardware/{{ $orderfixhardware->id }}" class="btn btn-light">{{ $orderfixhardware->id }}</a></td>
