...
@section('content')
    ...
    @endif
        ...
        @if ($orderfixhardware->status == "Waiting for Approval")
            <div class="row">
                <form action="/authfixhardware/{{$orderfixhardware->id}}/approve" method="post">
                    @method('patch')
                    @csrf
                    <div class="col-sm-1">
                ...
                <form action="/authfixhardware/{{$orderfixhardware->id}}/reject" method="post">
                    @method('patch')
                    @csrf
                    <div class="col-sm-1">
        ...
        <a href="/myfixhardware" class="btn btn-dark">Back</a>   
